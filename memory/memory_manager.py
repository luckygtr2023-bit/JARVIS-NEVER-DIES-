...
def extract_memory(user_text: str, brahma_text: str, api_key: str = "") -> dict:
    try:
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a J.A.R.V.I.S. assistant')\n"
            ...
            f"- Extract from BOTH user and J.A.R.V.I.S. turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"J.A.R.V.I.S. assistant"}}}},\n'
